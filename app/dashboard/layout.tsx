...
>
  ...
  {userDetails.isLoggedIn ? (
    ...
    <p>Hey, Please login to see more exciting features !</p>
  )}
...
<CircleUserRound />
         ...
         <DropdownMenuLabel>
          <span className="div flex place-items-center gap-2">
<Mail /> {userDetails.email}
          </span>
          </DropdownMenuLabel>
         <DropdownMenuLabel>
          <span className="div flex place-items-center gap-2">
<UsersIcon />{userDetails.username}
          </span>
          </DropdownMenuLabel>
         ...
         {/* //TODO implement logout function here*/}
